    ...
    <div className="min-h-screen bg-[#03010d] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-amber-900/25 bg-[#0a0807]/95 backdrop-blur-xl p-7 shadow-2xl shadow-black/60">
          <p className="text-center text-sm text-slate-500 mb-5">Dołącz do Cosmogram</p>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <input type="password" required placeholder="min. 6 znaków" minLength={6} value={password}
              ...
              <p className="mt-5 text-center text-xs text-slate-500">
                Masz już konto?{" "}
                <Link href={`${ROUTES.public.login.path}${redirectTo !== ROUTES.app.today.path ? `?redirect=${encodeURIComponent(redirectTo)}` : ""}`}
