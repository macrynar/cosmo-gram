...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://cosmogram.pl/contact" },
};
    ...
    <div className="min-h-screen bg-[#03010d] text-white">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 pt-28 pb-24">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400">Pytania i sugestie: <a href="mailto:hello@cosmogram.pl" className="text-amber-400 hover:text-amber-300 transition-colors">hello@cosmogram.pl</a></p>
        </div>
      </main>
      <Footer />
    </div>
