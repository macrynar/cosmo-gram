...
export default function AppHoroscopePage() {
  ...
  const loadReadings = useCallback(async () => {
    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        setDailyReading(data[0].daily_reading || "");
  ...
  async function handleGenerateDaily() {
    ...
    try {
      ...
      if (!chartRes.ok) throw new Error("Nie udało się przygotować danych kosmogramu.");
      ...
      if (!dailyRes.ok) throw new Error("Nie udało się wygenerować dziennego horoskopu.");
